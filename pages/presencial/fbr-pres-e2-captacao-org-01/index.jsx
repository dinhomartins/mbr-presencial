...
export default function Obrigado() {
  ...
  return (
<div>
  <div className="flex items-center justify-center h-screen bg-[url('/imgpgvendas/bgobrigado.webp')] bg-cover bg-no-repeat mx-auto px-[20px]">
    <div className="w-full max-w-[1100px] h-full flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center h-full">
        ...
        <span className="text-[#fff] text-center lg:mx-[100px] lg:leading-[34px] text-[20px] leading-[24px] lg:text-[30px] lg:mt-[20px] mt-[20px] lg:mb-[20px]">
            Para entrar na lista de interessadas do próximo evento <br  className="hidden lg:block" /> Bem Resolvida com Cátia Damasceno, preencha os dados abaixo. 
            </span>
