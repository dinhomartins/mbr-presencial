...
import S1 from '@/components/CapSection1HeaderRebeca'
...
const CapSectionVideo = dynamic(() => import('../../../components/CapSectionVideoRebeca'), { ssr: false });
const CapSection4Cards = dynamic(() => import('../../../components/CapSection4Cards'), { ssr: false });
const CapSection5OfertaRebeca = dynamic(() => import('../../../components/CapSection5OfertaRebeca'), { ssr: false });
