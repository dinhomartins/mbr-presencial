...
import S1 from '@/components/CapSection1HeaderLatentacion'
...
const CapSectionVideoMasterLove = dynamic(() => import('../../../components/CapSectionVideoLatentacion'), { ssr: false });
const CapSection4Cards = dynamic(() => import('../../../components/CapSection4Cards'), { ssr: false });
const CapSection5OfertaMasterLove = dynamic(() => import('../../../components/CapSection5OfertaLatentacion'), { ssr: false });
...
export default function Latentacion() {
