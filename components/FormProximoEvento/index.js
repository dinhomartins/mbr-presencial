...
function Index(props) {
  ...
  return (
    <form
      ...
      id="_form_140"
      className="_form _form_140 _inline-form _dark mt-4 lg:mt-0 mx-auto lg:mx-0 max-w-[360px] lg:max-w-[550px] w-full font-['poppins']"
    >
      ...
      <div className="_form-content">
        ...
        <div className="_button-wrapper _full_width">
          <button
            ...
            type="submit"
          >
            <span> Quero entrar para a lista de espera</span>
          </button>
        </div>
