...
function Index(props) {
  ...
  return (
    <form
      ...
      id="_form_124"
      className="_form _form_124 _inline-form _dark mt-4 lg:mt-0 mx-auto lg:mx-0 max-w-[360px] lg:max-w-[550px] w-full font-['poppins']"
    >
      ...
      <input type="hidden" name="or" value="c2adf4fb449996c373c6111ca485e296" />
