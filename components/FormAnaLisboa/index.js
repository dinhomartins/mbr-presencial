...
function Index(props) {
  ...
  return (
    <form
      ...
      id="_form_116"
      className="_form _form_116 _inline-form _dark mt-4 lg:mt-0 mx-auto lg:mx-0 max-w-[360px] lg:max-w-[550px] w-full font-['poppins']"
    >
      ...
      <input type="hidden" name="or" value="dab2356317d4ccd66debcfbc567d3151" />
      <div className="_form-content">
        ...
        <div className="_form_element text-[#585858] _x62307445 _full_width">
          <input
            type="hidden"
            name="field[488]"
            value={field4Value}
        ...
        <div className="_form_element  text-[#585858]  _x12772397 _full_width">
          <input
            type="hidden"
            name="field[483]"
            value={field6Value}
        ...
        <div className="_form_element  text-[#585858] _x70097653 _full_width">
          <input
            type="hidden"
            name="field[484]"
            value={field7Value}
        ...
        <div className="_form_element  text-[#585858] _x08534094 _full_width">
          <input
            type="hidden"
            name="field[485]"
            value={field8Value}
        ...
        <div className="_form_element  text-[#585858] _x67763874 _full_width">
          <input
            type="hidden"
            name="field[486]"
            value={field9Value}
        ...
        <div className="_form_element  text-[#585858] _x71539579 _full_width">
          <input
            type="hidden"
            name="field[487]"
            value={field10Value}
