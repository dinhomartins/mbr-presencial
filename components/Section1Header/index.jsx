            ...
            <div className="lg:bg-[url('/imgpgvendas/b01d.webp')]  bg-[url('/imgpgvendas/b1m.webp')]   mx-auto pb-[40px] pt-[25px] lg:pt-[35px] lg:bg-top bg-botton lg:pb-[100px] md:bg-bottom bg-cover bg-no-repeat">
                <Container>
                        ...
                        <div className="lg:w-1/2 md:w-1/2 text-center lg:text-left md:text-left ">
                            <div className=" flex flex-col lg:text-left relative  max-w-[1100px] mx-auto lg:mt-[10px]  ] ">
                                <Image
                                    ...
                                    alt="Bem resolvida"
                                />
                                <h3 className=" text-[#fff]  text-[20px]  lg:text-[24px] mt-[15px] lg:mt-[20px] tracking-[2px] lg:tracking-[1px]  leading-[26px]   lg:leading-[34px]" style={{ fontFamily: "'Epilogue', 'Libre Caslon Text', serif" }}>
                                    Toda mulher pode ser Bem Resolvida, livre e independente, mas muitas se perdem ao longo da jornada.
                                </h3>

                                <h3 className="font-bold text-[20px] text-[#E0A45B] lg:mr-[150px] lg:text-[28px] mt-[15px] lg:mt-[10px] tracking-[2px] lg:tracking-[1px]  leading-[26px]   lg:leading-[34px]" style={{ fontFamily: "'Epilogue', 'Libre Caslon Text', serif" }}>
                                    Descubra o caminho para uma vida bem resolvida.
                                </h3>

                                <h4 className=" text-[16px] text-[#fff] lg:text-[18px] lg:leading-[24px] lg:mt-[10px] mt-[10px] lg:mt-0 tracking-[2px] lg:tracking-[1px]  leading-[20px]" style={{ fontFamily: "'Lato', serif" }}>
                    ...
                    <div className="max-w-[1196px] w-full mx-auto lg:p-4 lg:pt-[80px] mt-[60px] text-center lg:pb-[80px]">
                        <h2 className="text-xl text-center  lg:text-center text-left mb-[40px] text-[#E0A45B]  text-[24px] lg:text-[20px] " style={{ fontFamily: "'Archivo', serif" }}>
                            INGRESSOS

                        </h2>

                        {/* texto versao mobile */}
                        <h2 className="text-[20px] leading-[24px] lg:hidden text-center text-[#fff] lg:block lg:text-center text-left mb-[40px] font-bold  text-[24px] lg:text-[40px] leading-[46px] " style={{ fontFamily: "'Epilogue', serif" }}>
                            O encontro Rem Resolvida é <span className="text-[#DB8E60]">para mulheres que querem:</span>

                        </h2>
                        

                        <h2 className="text-[20px] leading-[24px] hidden text-center text-[#fff] lg:block lg:text-center text-left mb-[40px] font-bold  text-[24px] lg:text-[40px] leading-[46px] " style={{ fontFamily: "'Epilogue', serif" }}>
                            O encontro Rem Resolvida é <br></br><span className="text-[#DB8E60]">para mulheres que querem:</span>
