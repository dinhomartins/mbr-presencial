...
export function useUtmParserSalesDiamante() {
    ...
    const link = `https://pay.hotmart.com/X89033557B?off=lng7iw8y&checkoutMode=10&sck=${source}&src=${source}|${medium}|${campaign}|${id}|${term}|${content}&utm_source=${source}&utm_medium=${medium}&utm_campaign=${campaign}&utm_id=${id}&utm_term=${term}&utm_content=${content}`;
    return link;
  }
